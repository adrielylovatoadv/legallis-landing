    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#0F0F0F]/90 backdrop-blur-md border-b border-[#C9A84C]/20">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <a href="https://app.legallis.app.br/cadastro/gratis" className="text-sm bg-[#C9A84C] hover:bg-[#B8973B] text-black font-semibold px-5 py-2 rounded-lg transition-colors">
            Testar grátis
          </a>
        </div>
      ...
      {open && (
        <div className="md:hidden bg-[#141414] border-t border-[#C9A84C]/20 px-6 py-4 flex flex-col gap-4">
          ...
          <a href="https://app.legallis.app.br/cadastro/gratis" className="bg-[#C9A84C] text-black text-sm font-semibold px-4 py-2 rounded-lg text-center">
            Testar grátis
          </a>
        </div>
      )}
